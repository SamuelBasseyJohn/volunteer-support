...
const FEATURES = [
  { icon: "🤝", title: "Find Opportunities", desc: "Browse hundreds of volunteer events filtered by skill, location, and date." },
  { icon: "🏆", title: "Track Your Impact", desc: "See your accepted events and application status in your personal dashboard." },
  { icon: "🏢", title: "For Organisations", desc: "Post opportunities, review applicants, and confirm attendance all in one place." },
]
...
const HomePage = () => {
  ...
  if (session) {
    // Authenticated: original home with latest events
    return (
      <div className="flex flex-col items-center justify-center min-h-[85vh] bg-gradient-to-b from-blue-800 to-blue-400 text-white px-6">
        ...
        <p className="text-xl text-blue-100 text-center mb-8">Allow us to find the right volunteers for you!</p>
  ...
  // Unauthenticated: beautiful landing page with CTAs in body
  return (
    <div className="min-h-[85vh] bg-gradient-to-b from-blue-900 via-blue-700 to-blue-400 text-white">
      ...
      <section className="flex flex-col items-center justify-center px-6 pt-20 pb-16 text-center">
        ...
        <p className="max-w-xl text-lg text-blue-100 mb-10">
          Whether you want to give your time or find skilled volunteers for your organisation,
          Volunteer Support is the platform that brings you together.
        </p>
      ...
      <section className="border-t border-white/20 bg-white/5 px-6 py-12 text-center">
        ...
        <p className="text-blue-100 mb-7">Join thousands of volunteers and organisations already on the platform.</p>
        <div className="flex flex-wrap justify-center gap-4">
          <Link
